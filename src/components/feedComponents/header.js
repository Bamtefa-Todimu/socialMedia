...
const Header = ({profilePicture,triggerCreateModal}) => {
    ...
    <div className="header-container">
        ...
        <div className="header-wrapper">
            ...
            <div className="links-section">
                ...
                <div className="profile-btn"onClick={() => setSelected(6)}><Link to = "/"><img src={window.localStorage.profilePicture} alt="" /></Link></div>
            </div>
        </div>
    </div>
  )
